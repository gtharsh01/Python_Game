...
def introImg(x,y):
    ...
    ###
    newImage= pygame.transform.scale(intro,(798,600))
    screen.blit(newImage,(x,y))
def instructionIMG(x,y):
    instruct = pygame.image.load("instruction.png")
    run = True
    while run:
        instruct = pygame.image.load("bb2.png")
        newImage1= pygame.transform.scale(instruct,(798,600))
        screen.blit(newImage1,(x,y))
...
def aboutIMG(x,y):
    ##aboutimg = pygame.image.load("bb2.png")
    ##newImage1= pygame.transform.scale(aboutimg,(798,600))
    ##screen.blit(newImage1,(0,0))
    run = True
    while run:
        aboutimg = pygame.image.load("bb3.png")
        newImage2= pygame.transform.scale(aboutimg,(798,600))
        screen.blit(newImage2,(x,y))
        pygame.display.update()
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                run = False
...
def countdown():
    ...
    countdownBacground = pygame.image.load('intro.png')
   
    newImage= pygame.transform.scale(countdownBacground,(798,600))
...
def gameloop():##etho error resolve krna by gameloop
    ...
    bg = pygame.image.load('331.jpg')
    newImage= pygame.transform.scale(bg,(798,600))
    screen.blit(newImage,(0,0))
    pygame.display.update()
